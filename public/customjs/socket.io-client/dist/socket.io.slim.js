...
!function (t, e) {
  ...
  return function (t) {
      ...
      try {
        ...
        try {
          if (this.extraHeaders) {
            ...
            for (var n in this.extraHeaders) this.extraHeaders.hasOwnProperty(n) && e.setRequestHeader(n, this.extraHeaders[n]);
          }
        } catch (t) {}
    ...
    e.encodePacket = function (t, e, r, i) {
      ...
      for (var o = t, i = []; o.byteLength > 0;) {
        ...
        if (a) try {
          ...
          for (var p = 0; p < u.length; p++) h += String.fromCharCode(u[p]);
        }
        i.push(h), o = f(o, c);
      }
    ...
    function n(t) {
      for (var e, r = t.length, n = -1, o = ""; ++n < r;) e = t[n], e > 65535 && (e -= 65536, o += d(e >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += d(e);
    ...
    function a(t, e) {
      ...
      for (var n, o = !1 !== e.strict, i = r(t), a = i.length, c = -1, p = ""; ++c < a;) n = i[c], p += s(n, o);
    ...
    if ("undefined" == typeof self) try {
      i = r(31);
    } catch (t) {} else o = self.WebSocket || self.MozWebSocket;
    var u = o || i;
