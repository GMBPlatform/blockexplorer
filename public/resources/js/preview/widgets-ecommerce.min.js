!function(t)
{
	...
	t(document).ready(function(){
		...
		if(e){echarts.init(e).setOption({title:null,legend:null,toolbox:null,tooltip:{show:!1},grid:{left:0,right:0,bottom:0,top:0},label:!1,series:[{
			type:"pie",
			hoverAnimation:!1,
			radius:"100%",
			center:["50%","50%"],
			...
			!0)}var l=t("#ecommerce-widget-e-chart");
			if(l.length){echarts.init(l.get(0)).setOption({tooltip:{trigger:"axis"},
			...
			axisLabel:{margin:20,fontFamily:"Open Sans",
			fontSize:12,color:"#939daa"}}],
			yAxis:[{splitLine:{lineStyle:{color:"#e9ebee"}},
			axisLine:{lineStyle:{color:"#e9ebee"}},
			axisTick:{show:!1},max:800,min:0,axisLabel:{fontFamily:"Open Sans",
			fontSize:12,color:"#939daa"}}],
			series:[{type:"line",
			data:[700,539,601,534,490,730,600],
